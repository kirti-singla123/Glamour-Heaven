...
const Hero = () => {
  ...
  return (
    <section className="relative flex items-start justify-center bg-gradient-hero overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-3 pb-8 sm:pt-4 sm:pb-10 relative z-10">
